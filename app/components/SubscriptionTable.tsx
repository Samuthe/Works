...
const SubscriptionsTable: FC<Props> = (props) => {
   ...
   * @param {string} status
   * @default status
   * @description returns the style for the status
   * @example getStatusStyle("Active") // returns "active"
   * @example getStatusStyle("Expired") // returns "expired"
   * @example getStatusStyle("Cancelled") // returns "cancelled"
   * @example getStatusStyle("Pending") // returns "pending"
   * @example getStatusStyle("Blocked") // returns "blocked"
   * @example getStatusStyle("default")
   * @example getStatusStyle("")
   * @returns {string} status style
   */
